...
#                           num_points: int) -> None:
#     points = a3_part3.generate_point_sequence1(vertex_points, initial_point, num_points)
#     assert a3_part3.verify_point_sequence1(vertex_points, initial_point, points)
...
def test_point_sequence_2(vertex_points: list[tuple[int, int]],
                          initial_point: tuple[int, int],
                          num_points: int) -> None:
    points = a3_part3.generate_point_sequence2(vertex_points, initial_point, num_points)
    assert a3_part3.verify_point_sequence2(vertex_points, initial_point, points)
