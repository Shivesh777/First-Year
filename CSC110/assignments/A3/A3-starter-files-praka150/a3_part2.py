"""CSC110 Fall 2022 Assignment 3, Part 2: Loops and Mutation Debugging Exercise
...
def clean_text(text: str) -> list[str]:
    ...
    Cleaning up involves:
        ...
        - converting all letters to lowercase (because our VADER keywords
          are all written as lowercase)l
    """
...
def test_star_wars() -> None:
    ...
    """
    review = read_critic_data('datasets/reviews/review_star_wars.csv')
...
def test_legally_blonde() -> None:
    ...
    There is NO ERROR in this test.
    """
    review = read_critic_data('datasets/reviews/review_legally_blonde.csv')
...
def test_transformers() -> None:
    ...
    There is NO ERROR in this test.
    """
    review = read_critic_data('datasets/reviews/review_transformers.csv')
...
if __name__ == '__main__':
    import pytest
    pytest.main(['a3_part2.py', '-v', '--no-header'])
